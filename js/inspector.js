...
(() => {
  ...
  function bind(){
    ...
    // NEU: Duplizieren-Button. duplicate() setzt die Selektion bereits auf
    // die Kopie und ruft refreshCanvas() auf; renderAll() folgt automatisch
    // über das state.subscribe-"selection"-Event weiter unten — kein
    // zusätzlicher renderAll()-Aufruf hier nötig.
