...
(() => {
  ...
  // Temporary fallback for the icons currently declared inside the legacy
  // editor. Once the icon registry is migrated, WebBuilderIconMap takes over.
